...
CONFIG_YAML="${CONFIG_YAML:-examples/Robotwin/train_files/starvla_train_robotwin_qwengroot_ascend.yaml}"
BASE_VLM="${BASE_VLM:-/home/hfang/public_datasets/starVLA/Pretrained_models/Qwen3-VL-4B-Instruct}"
DATA_ROOT_DIR="${DATA_ROOT_DIR:-/home/hfang/public_datasets/starVLA/Datasets/RoboTwin-Randomized/Clean}"
...
RUN_ID="${RUN_ID:-robotwin_qwengroot_ascend}"
